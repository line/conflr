...
* `CONFLUENCE_PASSWORD`: Your password (On Atlassian Cloud, your API token. For more details, please see <https://confluence.atlassian.com/cloud/api-tokens-938839638.html>).

There are several ways to set the variables. You can enter the environment variables in the popups that are displayed when you run the install command (see Usages section).
