...
There are several ways to set the variables. The most quick qay is to enter the environment variables in the popups that are displayed when you run the install command (see Usages section below).
