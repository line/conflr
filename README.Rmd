...
There are several ways to set theese. The quickest way is to enter the environmental variables in the popups that are displayed when you run the install command (see Usages section below).
